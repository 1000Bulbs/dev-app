          ...
          $(function(){ 
             ...
             var key, value, locationData = {};
              ...
              for(var y = 0; y <= storenum; y++) { 
                ...
                marker = createMarker(point, locationset[y]['name'], locationset[y]['address'], letter,  locationset[y]['open_year'] );
                marker.set("id", y);
                markers[y] = marker;
                if((settings.fullMapStart === true && firstRun === true) || settings.zoomLevel === 0){
                  bounds.extend(point);
             ...
             // function createMarker(point, name, address, letter){
               ...
               // var pinImage = new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=" + letter + "|" + settings.pinColor + "|" + settings.pinTextColor,
                 ...
                 // new google.maps.Point(10, 34));
		           ...
		           //Custom Marker - BD
				   function createMarker(point, name, address, letter, opening) {
					if(opening.match(/2014/i)) {
						
						var pinImage =new google.maps.MarkerImage("http://staging.freshthyme.com/images/FTM-green-drop.png", null, null,
						new google.maps.Point(14, 13)); 
						var pinShadow = new google.maps.MarkerImage("http://staging.freshthyme.com/images/FTM-green-drop.png", null, null,
						new google.maps.Point(14, 13)); 
						
					} else if(opening.match(/2015/i)) {
						
						var pinImage =new google.maps.MarkerImage("http://staging.freshthyme.com/images/FTM-red-drop.png", null, null,
						new google.maps.Point(14, 13)); 
						var pinShadow = new google.maps.MarkerImage("http://staging.freshthyme.com/images/FTM-red-drop.png", null, null,
						new google.maps.Point(14, 13)); 
						
					} else if(opening.match(/2016/i)) {
						
						var pinImage =new google.maps.MarkerImage("http://staging.freshthyme.com/images/FTM-yellow-drop.png", null, null,
						new google.maps.Point(14, 13)); 
						var pinShadow = new google.maps.MarkerImage("http://staging.freshthyme.com/images/FTM-yellow-drop.png", null, null,
						new google.maps.Point(14, 13)); 
